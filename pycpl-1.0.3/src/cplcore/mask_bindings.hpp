...
#ifndef PYCPL_MASK_BINDINGS_HPP
#define PYCPL_MASK_BINDINGS_HPP
...
/**
 * @brief Binds the Mask class (from mask.hpp)
 ...
 * src/bindings.cpp
 */
void bind_mask(py::module& m);

#endif  // PYCPL_MASK_BINDINGS_HPP