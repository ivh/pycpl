...
/* Swap macro */
#define CPL_TYPE_SWAP(a, b)              \
    {                                    \
        register const CPL_TYPE t = (a); \
        (a) = (b);                       \
        (b) = t;                         \
    }
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_0th)(CPL_TYPE *self, size_t n)
{
    CPL_TYPE min = self[0];
    size_t amin = 0;
    size_t i;
...
/*----------------------------------------------------------------------------*/
void
ADDTYPE(cpl_tools_flip)(CPL_TYPE *self, size_t n)
{
...
ADDTYPE(cpl_tools_get_median)(CPL_TYPE *self, cpl_size n)
{
    ...
    return (n & 1) ? self[(n - 1) / 2] /* Odd number */
                   : self[n / 2 - 1] + (self[n / 2] - self[n / 2 - 1]) /
                                           ((CPL_TYPE)2); /* Even number */
}
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_median_3)(CPL_TYPE *self)
{
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_median_5)(CPL_TYPE *self)
{
#ifdef CPL_TOOLS_STRICT_ERROR_CHECKING
    cpl_ensure(self != NULL, CPL_ERROR_NULL_INPUT, (CPL_TYPE)0);
#endif
    ...
    CPL_TYPE_SORT(self[0], self[3]);
    CPL_TYPE_SORT(self[1], self[4]);
    CPL_TYPE_SORT(self[1], self[2]);
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_median_6)(CPL_TYPE *self)
{
#ifdef CPL_TOOLS_STRICT_ERROR_CHECKING
    cpl_ensure(self != NULL, CPL_ERROR_NULL_INPUT, (CPL_TYPE)0);
#endif
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_median_7)(CPL_TYPE *self)
{
#ifdef CPL_TOOLS_STRICT_ERROR_CHECKING
    cpl_ensure(self != NULL, CPL_ERROR_NULL_INPUT, (CPL_TYPE)0);
#endif

    CPL_TYPE_SORT(self[0], self[5]);
    CPL_TYPE_SORT(self[0], self[3]);
    CPL_TYPE_SORT(self[1], self[6]);
    CPL_TYPE_SORT(self[2], self[4]);
    CPL_TYPE_SORT(self[0], self[1]);
    CPL_TYPE_SORT(self[3], self[5]);
    CPL_TYPE_SORT(self[2], self[6]);
    CPL_TYPE_SORT(self[2], self[3]);
    CPL_TYPE_SORT(self[3], self[6]);
    CPL_TYPE_SORT(self[4], self[5]);
    CPL_TYPE_SORT(self[1], self[4]);
    CPL_TYPE_SORT(self[1], self[3]);
    CPL_TYPE_SORT(self[3], self[4]);
}
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_median_9)(CPL_TYPE *self)
{
#ifdef CPL_TOOLS_STRICT_ERROR_CHECKING
    cpl_ensure(self != NULL, CPL_ERROR_NULL_INPUT, (CPL_TYPE)0);
#endif
    ...
    CPL_TYPE_SORT(self[1], self[2]);
    CPL_TYPE_SORT(self[4], self[5]);
    CPL_TYPE_SORT(self[7], self[8]);
    CPL_TYPE_SORT(self[0], self[1]);
    CPL_TYPE_SORT(self[3], self[4]);
    CPL_TYPE_SORT(self[6], self[7]);
    CPL_TYPE_SORT(self[1], self[2]);
    CPL_TYPE_SORT(self[4], self[5]);
    CPL_TYPE_SORT(self[7], self[8]);
    CPL_TYPE_SORT(self[0], self[3]);
    CPL_TYPE_SORT(self[5], self[8]);
    CPL_TYPE_SORT(self[4], self[7]);
    CPL_TYPE_SORT(self[3], self[6]);
    CPL_TYPE_SORT(self[1], self[4]);
    CPL_TYPE_SORT(self[2], self[5]);
    CPL_TYPE_SORT(self[4], self[7]);
    CPL_TYPE_SORT(self[4], self[2]);
    CPL_TYPE_SORT(self[6], self[4]);
    CPL_TYPE_SORT(self[4], self[2]);
}
...
/*----------------------------------------------------------------------------*/
static void
ADDTYPE(cpl_tools_get_median_25)(CPL_TYPE *self)
{
#ifdef CPL_TOOLS_STRICT_ERROR_CHECKING
    cpl_ensure(self != NULL, CPL_ERROR_NULL_INPUT, (CPL_TYPE)0);
#endif
    ...
    CPL_TYPE_SORT(self[2], self[3]);
    CPL_TYPE_SORT(self[6], self[7]);
    CPL_TYPE_SORT(self[5], self[7]);
    CPL_TYPE_SORT(self[5], self[6]);
    CPL_TYPE_SORT(self[9], self[10]);
    CPL_TYPE_SORT(self[8], self[10]);
    CPL_TYPE_SORT(self[8], self[9]);
    CPL_TYPE_SORT(self[12], self[13]);
    CPL_TYPE_SORT(self[11], self[13]);
    CPL_TYPE_SORT(self[11], self[12]);
    CPL_TYPE_SORT(self[15], self[16]);
    CPL_TYPE_SORT(self[14], self[16]);
    CPL_TYPE_SORT(self[14], self[15]);
    CPL_TYPE_SORT(self[18], self[19]);
    CPL_TYPE_SORT(self[17], self[19]);
    CPL_TYPE_SORT(self[17], self[18]);
    CPL_TYPE_SORT(self[21], self[22]);
    CPL_TYPE_SORT(self[20], self[22]);
    CPL_TYPE_SORT(self[20], self[21]);
    CPL_TYPE_SORT(self[23], self[24]);
    CPL_TYPE_SORT(self[2], self[5]);
    CPL_TYPE_SORT(self[3], self[6]);
    CPL_TYPE_SORT(self[0], self[6]);
    CPL_TYPE_SORT(self[0], self[3]);
    CPL_TYPE_SORT(self[4], self[7]);
    CPL_TYPE_SORT(self[1], self[7]);
    CPL_TYPE_SORT(self[1], self[4]);
    CPL_TYPE_SORT(self[11], self[14]);
    CPL_TYPE_SORT(self[8], self[14]);
    CPL_TYPE_SORT(self[8], self[11]);
    CPL_TYPE_SORT(self[12], self[15]);
    CPL_TYPE_SORT(self[9], self[15]);
    CPL_TYPE_SORT(self[9], self[12]);
    CPL_TYPE_SORT(self[13], self[16]);
    CPL_TYPE_SORT(self[10], self[16]);
    CPL_TYPE_SORT(self[10], self[13]);
    CPL_TYPE_SORT(self[20], self[23]);
    CPL_TYPE_SORT(self[17], self[23]);
    CPL_TYPE_SORT(self[17], self[20]);
    CPL_TYPE_SORT(self[21], self[24]);
    CPL_TYPE_SORT(self[18], self[24]);
    CPL_TYPE_SORT(self[18], self[21]);
    CPL_TYPE_SORT(self[19], self[22]);
    CPL_TYPE_SORT(self[8], self[17]);
    CPL_TYPE_SORT(self[9], self[18]);
    CPL_TYPE_SORT(self[0], self[18]);
    CPL_TYPE_SORT(self[0], self[9]);
    CPL_TYPE_SORT(self[10], self[19]);
    CPL_TYPE_SORT(self[1], self[19]);
    CPL_TYPE_SORT(self[1], self[10]);
    CPL_TYPE_SORT(self[11], self[20]);
    CPL_TYPE_SORT(self[2], self[20]);
    CPL_TYPE_SORT(self[2], self[11]);
    CPL_TYPE_SORT(self[12], self[21]);
    CPL_TYPE_SORT(self[3], self[21]);
    CPL_TYPE_SORT(self[3], self[12]);
    CPL_TYPE_SORT(self[13], self[22]);
    CPL_TYPE_SORT(self[4], self[22]);
    CPL_TYPE_SORT(self[4], self[13]);
    CPL_TYPE_SORT(self[14], self[23]);
    CPL_TYPE_SORT(self[5], self[23]);
    CPL_TYPE_SORT(self[5], self[14]);
    CPL_TYPE_SORT(self[15], self[24]);
    CPL_TYPE_SORT(self[6], self[24]);
    CPL_TYPE_SORT(self[6], self[15]);
    CPL_TYPE_SORT(self[7], self[16]);
    CPL_TYPE_SORT(self[7], self[19]);
    CPL_TYPE_SORT(self[13], self[21]);
    CPL_TYPE_SORT(self[15], self[23]);
    CPL_TYPE_SORT(self[7], self[13]);
    CPL_TYPE_SORT(self[7], self[15]);
    CPL_TYPE_SORT(self[1], self[9]);
    CPL_TYPE_SORT(self[3], self[11]);
    CPL_TYPE_SORT(self[5], self[17]);
    CPL_TYPE_SORT(self[11], self[17]);
    CPL_TYPE_SORT(self[9], self[17]);
    CPL_TYPE_SORT(self[4], self[10]);
    CPL_TYPE_SORT(self[6], self[12]);
    CPL_TYPE_SORT(self[7], self[14]);
    CPL_TYPE_SORT(self[4], self[6]);
    CPL_TYPE_SORT(self[4], self[7]);
    CPL_TYPE_SORT(self[12], self[14]);
    CPL_TYPE_SORT(self[10], self[14]);
    CPL_TYPE_SORT(self[6], self[7]);
    CPL_TYPE_SORT(self[10], self[12]);
    CPL_TYPE_SORT(self[6], self[10]);
    CPL_TYPE_SORT(self[6], self[17]);
    CPL_TYPE_SORT(self[12], self[17]);
    CPL_TYPE_SORT(self[7], self[17]);
    CPL_TYPE_SORT(self[7], self[10]);
    CPL_TYPE_SORT(self[12], self[18]);
    CPL_TYPE_SORT(self[7], self[12]);
    CPL_TYPE_SORT(self[10], self[18]);
    CPL_TYPE_SORT(self[12], self[20]);
    CPL_TYPE_SORT(self[10], self[20]);
    CPL_TYPE_SORT(self[10], self[12]);
}
...
/*----------------------------------------------------------------------------*/
double
ADDTYPE(cpl_tools_get_mean)(const CPL_TYPE *a, cpl_size nn)
{
    double mean = 0.0;
...
/*----------------------------------------------------------------------------*/
double
ADDTYPE(cpl_tools_get_variancesum)(const CPL_TYPE *a,
                                   cpl_size nn,
                                   double *pmean)
{
    double varsum = 0.0;
...
/*----------------------------------------------------------------------------*/
double
ADDTYPE(cpl_tools_get_variance)(const CPL_TYPE *a, cpl_size n, double *pmean)
{
...
/*----------------------------------------------------------------------------*/
static int
ADDTYPE(compar_ascn)(const void *p1, const void *p2)
{
...
/*----------------------------------------------------------------------------*/
static int
ADDTYPE(compar_desc)(const void *p1, const void *p2)
{
    const CPL_TYPE a1 = *(const CPL_TYPE *)p1;
    const CPL_TYPE a2 = *(const CPL_TYPE *)p2;
...
/*----------------------------------------------------------------------------*/
void
ADDTYPE(cpl_tools_sort_ascn)(CPL_TYPE *self, int n)
{
...
/*----------------------------------------------------------------------------*/
void
ADDTYPE(cpl_tools_sort_desc)(CPL_TYPE *self, int n)
{
...
/*----------------------------------------------------------------------------*/
cpl_error_code
ADDTYPE(cpl_tools_permute)(cpl_size *self,
                           cpl_size n,
                           CPL_TYPE *awrite,
