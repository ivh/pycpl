...
/*-----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
static void
cpl_errorstate_dump_one_level(void (*)(const char *, const char *, ...)
                                  CPL_ATTR_PRINTF(2, 3),
                              unsigned,
                              unsigned,
                              unsigned);
...
/*----------------------------------------------------------------------------*/
cpl_boolean
cpl_errorstate_is_equal(cpl_errorstate self)
{
    const size_t myself = (const size_t)self;
...
/*----------------------------------------------------------------------------*/
void
cpl_errorstate_dump(cpl_errorstate self,
                    cpl_boolean reverse,
...
/*----------------------------------------------------------------------------*/
void
cpl_errorstate_dump_one(unsigned self, unsigned first, unsigned last)
{
...
/*----------------------------------------------------------------------------*/
void
cpl_errorstate_dump_one_warning(unsigned self, unsigned first, unsigned last)
{
...
/*----------------------------------------------------------------------------*/
void
cpl_errorstate_dump_one_info(unsigned self, unsigned first, unsigned last)
{
...
/*----------------------------------------------------------------------------*/
void
cpl_errorstate_dump_one_debug(unsigned self, unsigned first, unsigned last)
{
...
/*----------------------------------------------------------------------------*/
static void
cpl_errorstate_dump_one_level(void (*messenger)(const char *,
                                                const char *,
                                                ...),
                              unsigned self,
                              unsigned first,
