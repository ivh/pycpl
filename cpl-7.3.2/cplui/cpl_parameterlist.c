...
cpl_parameterlist_get_first(cpl_parameterlist *self)
{
    ...
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_get_first_const(self);
...
cpl_parameterlist_get_next(cpl_parameterlist *self)
{
    cpl_errorstate prestate = cpl_errorstate_get();
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_get_next_const(self);
...
cpl_parameterlist_get_last(cpl_parameterlist *self)
{
    cpl_errorstate prestate = cpl_errorstate_get();
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_get_last_const(self);
...
cpl_parameterlist_find(cpl_parameterlist *self, const char *name)
{
    cpl_errorstate prestate = cpl_errorstate_get();
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_find_const(self, name);
...
cpl_parameterlist_find_type(cpl_parameterlist *self, cpl_type type)
{
    cpl_errorstate prestate = cpl_errorstate_get();
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_find_type_const(self, type);
...
cpl_parameter *
cpl_parameterlist_find_context(cpl_parameterlist *self, const char *context)
{
    cpl_errorstate prestate = cpl_errorstate_get();
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_find_context_const(self, context);
...
cpl_parameterlist_find_tag(cpl_parameterlist *self, const char *tag)
{
    cpl_errorstate prestate = cpl_errorstate_get();
    cpl_parameter *par =
        (cpl_parameter *)cpl_parameterlist_find_tag_const(self, tag);
