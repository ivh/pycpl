                             ...
                             const cpl_frame *inherit_frame)
{
    ...
    const cpl_cstr *exactkeys[] = {
        CXSTR("ORIGIN", 6),   CXSTR("TELESCOP", 8), CXSTR("INSTRUME", 8),
        CXSTR("OBJECT", 6),   CXSTR("RA", 2),       CXSTR("DEC", 3),
        CXSTR("EPOCH", 5),    CXSTR("EQUINOX", 7),  CXSTR("RADESYS", 7),
        CXSTR("DATE-OBS", 8), CXSTR("MJD-OBS", 7),  CXSTR("UTC", 3),
        CXSTR("LST", 3),      CXSTR("PI-COI", 6),   CXSTR("OBSERVER", 8),
        CXSTR("RADECSYS", 8), CXSTR("ARCFILE", 7)
    };
