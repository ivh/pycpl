...
#define CPL_WCS_REGEXP                            \
    "WCSAXES|WCSNAME|(PC|CD|PV|PS)[0-9]+_[0-9]+|" \
...
cpl_wcs *
cpl_wcs_new_from_propertylist(const cpl_propertylist *plist) CPL_ATTR_ALLOC;
void cpl_wcs_delete(cpl_wcs *wcs);

cpl_wcs *cpl_wcs_duplicate(const cpl_wcs *other) CPL_ATTR_ALLOC;
