...
{
    const cpl_unit units[] = {CPL_UNIT_LESS,           CPL_UNIT_RADIAN,
                              CPL_UNIT_LENGTH,         CPL_UNIT_TIME,
                              CPL_UNIT_PERLENGTH,      CPL_UNIT_FREQUENCY,
                              CPL_UNIT_MASS,           CPL_UNIT_ACCELERATION,
                              CPL_UNIT_FORCE,          CPL_UNIT_ENERGY,
                              CPL_UNIT_PHOTONRADIANCE, CPL_UNIT_ENERGYRADIANCE};
