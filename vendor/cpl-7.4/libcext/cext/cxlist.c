...
cx_list_iterator
cx_list_erase(cx_list *list, cx_list_iterator position, cx_free_func deallocate)
{
    cx_lnode *next;
...
void
cx_list_splice(cx_list *tlist, cx_list_iterator position, cx_list *slist,
               cx_list_iterator first, cx_list_iterator last)
{
    (void)slist; /* Prevent warnings if cx_assert is disabled. */
    (void)tlist; /* Prevent warnings if cx_assert is disabled. */
