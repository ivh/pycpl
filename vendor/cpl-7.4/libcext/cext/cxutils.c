...
#  include <stdlib.h>
#endif
#if !defined(HAVE_VA_COPY_STYLE_FUNCTION) && \
    !defined(HAVE_VA_LIST_COPY_BY_VALUE)
#  include <string.h>
#endif
#ifdef HAVE_UNISTD_H
#  include <unistd.h>
...
cxint
cx_bits_find(cxuint32 mask, cxint start)
{
...
cxint
cx_bits_rfind(cxuint32 mask, cxint start)
{
...
cxint
cx_snprintf(cxchar *string, cxsize n, const cxchar *format, ...)
{
    va_list args;
    cxint nc;
...
cxint
cx_vsnprintf(cxchar *string, cxsize n, const cxchar *format, va_list args)
{
    if (n != 0 && string == NULL) {
        return 0;
    }
...
cxint
cx_asprintf(cxchar **string, const cxchar *format, ...)
{
    va_list args;
    cxint nc;
...
cxint
cx_vasprintf(cxchar **string, const cxchar *format, va_list args)
{
    cxint nc;
