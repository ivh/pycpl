...
/*----------------------------------------------------------------------------*/
cpl_error_code
cpl_image_fill_noise_uniform(cpl_image *ima, double min_pix, double max_pix)
{
    int i, j;
...
/*----------------------------------------------------------------------------*/
cpl_error_code
cpl_image_fill_gaussian(cpl_image *ima,
                        double xcen,
                        double ycen,
                        double norm,
                        double sig_x,
...
/*----------------------------------------------------------------------------*/
cpl_error_code
cpl_image_fill_polynomial(cpl_image *ima,
...
/*----------------------------------------------------------------------------*/
cpl_image *
cpl_image_fill_test_create(cpl_size nx, cpl_size ny)
{
    const double xposrate[] = {0.4, 0.5, 0.8, 0.9, 0.2,
                               0.5, 0.9, 0.3, 0.1, 0.7};
...
/*----------------------------------------------------------------------------*/
static double
cpl_gaussian_2d(double x, double y, double norm, double sig_x, double sig_y)
{
    return norm /
           (sig_x * sig_y * CPL_MATH_2PI *
            exp(x * x / (2.0 * sig_x * sig_x) + y * y / (2.0 * sig_y * sig_y)));
}
