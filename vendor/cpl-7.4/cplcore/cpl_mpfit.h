...
struct mp_config_struct
{
    ...
    double
        epsfcn; /* Finite derivative step size               Default: MP_MACHEP0 */
    double
        stepfactor; /* Initial step bound                     Default: 100.0 */
    double
        covtol;  /* Range tolerance for covariance calculation Default: 1e-14 */
...
extern int cpl_mpfit(mp_func funct,
                     int m,
                     int npar,
                     double *xall,
                     mp_par *pars,
