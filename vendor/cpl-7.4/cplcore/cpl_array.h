...
cpl_array *cpl_array_new(cpl_size, cpl_type) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_int(int *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_long(long *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_long_long(long long *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_cplsize(cpl_size *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_float(float *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_double(double *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *
cpl_array_wrap_float_complex(_Complex float *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *
cpl_array_wrap_double_complex(_Complex double *, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_wrap_string(char **, cpl_size) CPL_ATTR_ALLOC;
cpl_array *cpl_array_new_complex_from_arrays(const cpl_array *,
                                             const cpl_array *) CPL_ATTR_ALLOC;
...
cpl_error_code
cpl_array_copy_data_complex(cpl_array *, const _Complex double *);
cpl_error_code
cpl_array_copy_data_float_complex(cpl_array *, const _Complex float *);
cpl_error_code
cpl_array_copy_data_double_complex(cpl_array *, const _Complex double *);
...
cpl_array_get_data_double_complex_const(const cpl_array *);
...
_Complex double
cpl_array_get_double_complex(const cpl_array *, cpl_size, int *);
...
cpl_error_code
cpl_array_set_float_complex(cpl_array *, cpl_size, _Complex float);
cpl_error_code
cpl_array_set_double_complex(cpl_array *, cpl_size, _Complex double);
...
cpl_error_code
cpl_array_fill_window_long(cpl_array *, cpl_size, cpl_size, long);
cpl_error_code
cpl_array_fill_window_long_long(cpl_array *, cpl_size, cpl_size, long long);
cpl_error_code
cpl_array_fill_window_cplsize(cpl_array *, cpl_size, cpl_size, cpl_size);
cpl_error_code
cpl_array_fill_window_float(cpl_array *, cpl_size, cpl_size, float);
cpl_error_code
cpl_array_fill_window_double(cpl_array *, cpl_size, cpl_size, double);
cpl_error_code
cpl_array_fill_window_string(cpl_array *, cpl_size, cpl_size, const char *);
cpl_error_code
cpl_array_fill_window_complex(cpl_array *, cpl_size, cpl_size, _Complex double);
cpl_error_code cpl_array_fill_window_float_complex(cpl_array *,
                                                   cpl_size,
                                                   cpl_size,
                                                   _Complex float);
cpl_error_code cpl_array_fill_window_double_complex(cpl_array *,
                                                    cpl_size,
                                                    cpl_size,
                                                    _Complex double);
cpl_error_code cpl_array_fill_window_invalid(cpl_array *, cpl_size, cpl_size);
cpl_array *cpl_array_duplicate(const cpl_array *) CPL_ATTR_ALLOC;
cpl_array *cpl_array_extract(const cpl_array *,
                             cpl_size start,
                             cpl_size count) CPL_ATTR_ALLOC;
cpl_array *cpl_array_extract_real(const cpl_array *) CPL_ATTR_ALLOC;
cpl_array *cpl_array_extract_imag(const cpl_array *) CPL_ATTR_ALLOC;
cpl_error_code
cpl_array_insert_window(cpl_array *, cpl_size start, cpl_size count);
cpl_error_code
cpl_array_erase_window(cpl_array *, cpl_size start, cpl_size count);
...
cpl_array *cpl_array_cast(const cpl_array *, cpl_type) CPL_ATTR_ALLOC;
