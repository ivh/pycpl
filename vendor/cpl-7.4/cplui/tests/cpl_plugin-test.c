...
main(void)
{
    ...
    const unsigned long version1 = 30507L, type1 = 1L;

    unsigned long aversion1, atype1;

    char *asversion1, *astype1;
    const char *asnull;
    const char *sversion1 = "3.5.7", *stype1 = "recipe",
               *sname1 = "eso.cpl.test", *asname1,
               *ssynopsis1 = "test_synopsis", *assynopsis1,
               *sdescription1 = "test_description", *asdescription1,
               *sauthor1 = "test_author", *asauthor1, *semail1 = "test_email",
               *asemail1, *scopyright1 = "test_copyright", *ascopyright1;

    cpl_plugin_func initialize1 = (cpl_plugin_func)1, ainitialize1,
                    execute1 = (cpl_plugin_func)1, aexecute1,
                    deinitialize1 = (cpl_plugin_func)1, adeinitialize1;
    ...
    ecode = cpl_plugin_init(NULL, api1, version1, type1, sname1, ssynopsis1,
                            sdescription1, sauthor1, semail1, scopyright1,
                            initialize1, execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);

    ecode = cpl_plugin_init(plgn1, api1, version1, type1, NULL, ssynopsis1,
                            sdescription1, sauthor1, semail1, scopyright1,
                            initialize1, execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);

    ecode = cpl_plugin_init(plgn1, api1, version1, type1, sname1, NULL,
                            sdescription1, sauthor1, semail1, scopyright1,
                            initialize1, execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);

    ecode = cpl_plugin_init(plgn1, api1, version1, type1, sname1, ssynopsis1,
                            NULL, sauthor1, semail1, scopyright1, initialize1,
                            execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);

    ecode = cpl_plugin_init(plgn1, api1, version1, type1, sname1, ssynopsis1,
                            sdescription1, NULL, semail1, scopyright1,
                            initialize1, execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);

    ecode = cpl_plugin_init(plgn1, api1, version1, type1, sname1, ssynopsis1,
                            sdescription1, sauthor1, NULL, scopyright1,
                            initialize1, execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);

    ecode = cpl_plugin_init(plgn1, api1, version1, type1, sname1, ssynopsis1,
                            sdescription1, sauthor1, semail1, NULL, initialize1,
                            execute1, deinitialize1);
    cpl_test_eq_error(ecode, CPL_ERROR_NULL_INPUT);
