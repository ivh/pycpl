...
main(void)
{
    ...
    cpl_plugin *pl1 = NULL, *pl2 = NULL, *pl3 = NULL, *pl4 = NULL, *pl5 = NULL,
               *front = NULL, *back = NULL, *search = NULL;
    ...
    error =
        cpl_plugin_init(pl1, 1, 10000, (unsigned long)CPL_PLUGIN_TYPE_RECIPE,
                        "cmdlcaller.test.plgn1", "synopsis1", "description1",
                        "Fname Lname", PACKAGE_BUGREPORT, eso_gpl_license, NULL,
                        NULL, NULL);
    ...
    error =
        cpl_plugin_init(pl2, 1, 10000, (unsigned long)CPL_PLUGIN_TYPE_RECIPE,
                        "cmdlcaller.test.plgn2", "synopsis2", "description2",
                        "Fname Lname", PACKAGE_BUGREPORT, eso_gpl_license, NULL,
                        NULL, NULL);
    cpl_test_eq_error(error, CPL_ERROR_NONE);
    ...
    error =
        cpl_plugin_init(pl3, 1, 10000, (unsigned long)CPL_PLUGIN_TYPE_RECIPE,
                        "cmdlcaller.test.plgn3", "synopsis3", "description3",
                        "Fname Lname", PACKAGE_BUGREPORT, eso_gpl_license, NULL,
                        NULL, NULL);
    cpl_test_eq_error(error, CPL_ERROR_NONE);
    ...
    error =
        cpl_plugin_init(pl4, 1, 10000, (unsigned long)CPL_PLUGIN_TYPE_RECIPE,
                        "cmdlcaller.test.plgn4", "synopsis4", "description4",
                        "Fname Lname", PACKAGE_BUGREPORT, eso_gpl_license, NULL,
                        NULL, NULL);
    cpl_test_eq_error(error, CPL_ERROR_NONE);
    ...
    error =
        cpl_plugin_init(pl5, 1, 10000, (unsigned long)CPL_PLUGIN_TYPE_RECIPE,
                        "cmdlcaller.test.plgn5", "synopsis5", "description5",
                        "Fname Lname", PACKAGE_BUGREPORT, eso_gpl_license, NULL,
                        NULL, NULL);
    cpl_test_eq_error(error, CPL_ERROR_NONE);
