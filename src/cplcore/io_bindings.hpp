...
#ifndef PYCPL_IO_BINDINGS_HPP
#define PYCPL_IO_BINDINGS_HPP
...
/**
 * @brief Bind IO enums to its own module that is to be used throughout cplcore
 * @param m The Pybind Python module to bind the IO enums to (cpl.core)
 *
